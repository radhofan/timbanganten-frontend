      ...
      <main style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "clamp(1rem, 3vh, 2rem) clamp(0.75rem, 2vw, 2rem)" }}>
        <div style={{ width: "100%", maxWidth: "clamp(300px, 40vw, 440px)", background: "#fff", border: "2px solid #0b0c0c" }}>
          <div style={{ background: "#0b0c0c", padding: "12px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
            <div>
              <div style={{ color: "#fff", fontWeight: 700, fontSize: "1rem", textTransform: "uppercase", letterSpacing: "0.04em" }}>Login Approver</div>
              <div style={{ color: "#b1b4b6", fontSize: "0.75rem" }}>Akses sistem approver</div>
            </div>
            <Image src="/images/approver.png" alt="Approver" width={28} height={28} style={{ objectFit: "contain", opacity: 0.8 }} />
          </div>
          ...
          <div style={{ padding: "20px" }}>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 14 }}>
                ...
                <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="approver@example.com" required
