...
import { FiCreditCard, FiRefreshCcw, FiAlertTriangle, FiCheckCircle, FiXCircle } from "react-icons/fi";
...
export default function Admin() {
  ...
  const [notifications, setNotifications] = useState([
    ...
    },
    {
      ...
      message: "Melwati batas perpanjangan",
      time: "11:05 AM",
    },
    {
      id: 7,
  ...
  return (
    <div className="mn-h-screen flex flex-col">
      <Header />
            ...
            {cards.map(({ title, imgSrc, href }, i) => (
              <Link key={i} href={href} className="w-full max-w-sm mx-auto">
                <div
                  ...
                  style={{
                    boxShadow: "-6px 6px 20px rgba(34, 61, 60, 0.8)",
                  }}
                >
