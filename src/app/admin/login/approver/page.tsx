      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div className="flex items-center mb-6">
          <Image
            ...
            className="mr-4"
          />
          <h2 className="text-2xl font-bold text-gray-800">Login Approver</h2>
          <select
            name="role"
            value={role}
            onChange={(e) => {
            ...
            className="ml-12 mt-1 border border-gray-300 rounded-md px-3 py-2 text-sm bg-white text-gray-700 shadow-sm hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
